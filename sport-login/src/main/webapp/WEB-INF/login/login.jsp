...
<link type="text/css" rel="stylesheet" href="<%=path%>/css/a.css" source="widget">
<script type="text/javascript" src="<%=path%>/css/jquery-1.js"></script>
			...
			<div class="w">
				<div class="login-form">
					<div class="login-box">
						...
						<div class="mc">
							<div class="form">
								<form id="loginForm" action="<%=path%>/login.aspx" method="post">
